...
const exercicioDeTreinoController = container.resolve(ExercicioDeTreinoController);
...
exercicioDeTreinoRoutes.get("/workouts/:treino_id", exercicioDeTreinoController.findByTreinoId);
