...
export const ExercicioDeTreinoSchema = z.object({
  ...
  exercicio_id: z
    .number()
    .int()
    .positive({ message: "O ID do exercício deve ser um número válido" }),
  series: z
    .number()
    .int()
  ...
  descanso_segundos: z.number().int().nonnegative({
    message: "O descanso em segundos deve ser um número não negativo",
  }),
});
